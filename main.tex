...
Although Grassroots is discipline-agnostic, as part of the DFW/DSW programmes a major focus of our work is research about wheat. 
...
\end{figure}
    ...
    \begin{figure*}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            ...
            \caption[{\label{fig:map_studies}The plots in a tabular view.}]%
            {{\small The plots in a tabular view}}    
            \label{fig:plots}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{plots_with_popup}
            \caption[{\label{fig:plots_with_popup}The plots in a tabular view with a given plot's information.}]%
            {{\small The plots in a tabular view with a given plot's information}}    
            \label{fig:plots_with_popup}
        \end{subfigure}
\end{figure*}
